...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" " href="../assets/img/favicon/dtpeduli.png" />
...
?>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Tabungan Qurban</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" action="../config/prosesLogin.php" method="POST">
                <div class="mb-3">
    ...
    <script>
  // Mengecek apakah ada pesan error dari session
